...
#define header
	...
	typedef enum AdtStatus{AllocationError=0,OK=1,WrongInput=2,ExceedingIDX=3}AdtStatus;
	/*forward declaration of th darray type*/
	...
	/*my addition to the functions-print functions*/
